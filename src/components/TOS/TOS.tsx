    ...
    <>
      <div id='TOS'>
        <Typography variant="h4" gutterBottom>
            Let's KeshuMeet Terms of Service and User License
        </Typography>
        <Typography variant="body1" gutterBottom>
            <p>This Let's KeshuMeet Terms of Service and User License ("TOS" or this “Agreement”) governs any access to and use of the applications, services and websites (collectively “Company Services”) offered or made available by Let's KeshuMeet ("Company" or “we/us”) at <a href='https://github.com/keshavjatt'>https://github.com/keshavjatt</a>, or through corresponding sites on social media outlets. This TOS is subject to modification from time to time as described below and You can review the most current version at any time at: <a href='https://github.com/keshavjatt'>https://github.com/keshavjatt</a>.</p>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <p>
            Notice of alleged copyright infringement or other legal notices regarding User Content appearing on the Site or Company Service shall be sent to <a href='mailto:thecoder780@gmail.com'>thecoder780@gmail.com</a>. Company reserves the right to remove, block or otherwise stop the Sharing of User Content alleged to be infringing or otherwise illegal without prior notice and at our sole discretion.
          </p>
          <Typography variant="h6" gutterBottom>
            C. Inappropriate and Illegal Content.
          </Typography>
          <p>
            You agree not to Share any User Content on, through or to the Company Services that is contrary to applicable laws and regulations or that (a) is pornographic, sexually explicit, obscene or indecent, (b) depicts real-life abusive, violent or illegal activity (subject to reasonable exceptions for legitimate news and educational materials), (c) communicates hate speech, threats, harassment, intimidation or invades another’s privacy, or (d) violates the rights of others.
          </p>
          <Typography variant="h6" gutterBottom>
            D. Other User’s Content.
          </Typography>
          <p>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <ul>
            <li>defame, abuse, harass, stalk, spam, threaten or otherwise violate the legal rights (such as rights of privacy and publicity) of others</li>
            <li>upload, post, display, transmit or otherwise Share any inappropriate, defamatory, libelous, infringing, obscene, or unlawful User Content</li>
            <li>upload, post, display, transmit or otherwise Share any User Content that infringes, misappropriates or violates any patent, trademark, copyright, trade secret or other proprietary right or privacy right of any party</li>
            <li>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <p>
            YOU EXPRESSLY UNDERSTAND AND AGREE THAT, TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, COMPANY, AND ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS AND LICENSORS, SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE SITE, COMPANY SERVICES (INCLUDING LET'S KeshuMeet APPLICATIONS), COMPANY MATERIALS, USER CONTENT, INFORMATION AND RESULTS AND OTHER CONTENT AND INFORMATION AVAILABLE THROUGH THE SITE OR COMPANY SERVICES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES). IN NO EVENT WILL COMPANY'S (OR ITS AFFILIATES’, OFFICERS’, DIRECTORS’, EMPLOYEES’, AGENTS’ AND LICENSORS’) CUMULATIVE LIABILITY TO YOU EXCEED US $100.00, EXCEPT TO THE EXTENT SUCH LIMITATION IS NOT PERMITTED BY APPLICABLE LAW.
          </p>
          <p>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <ul>
            <li>(a) You own the computer or device on which You are using the Let's KeshuMeet Website on, or have the authority to use the Let's KeshuMeet Website on such computer or device</li>
            <li>(b) your use of the Company Services will not violate any local, state or federal laws that apply to You</li>
            <li>(c) Company is not causing the Let's KeshuMeet Website to be used on your computer or device, but has provided the Let's KeshuMeet Website to You, which You are using of your own volition</li>
            ...
            <li>(g) You are over the age of 13, as the Company Services are not intended for children under 13.</li>
          </ul>
        </Typography>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <ul>
            <li>(a) electronic means to complete this Agreement and to provide You with any notices given pursuant to this Agreement; and</li>
            <li>(b) electronic records to store information related to this Agreement or your use of the Site and Company Services.</li>
          </ul>
        </Typography>

        <Typography variant="h5" gutterBottom>
          XII. VIOLATIONS AND COMMENTS
        </Typography>
        <Typography variant="body1" gutterBottom>
          <p>
            Please report any violations of the Agreement or provide any comments or questions by emailing us at <a href='mailto:thecoder780@gmail.com'>thecoder780@gmail.com</a>. You agree, however, that: (i) by submitting ideas regarding the Company Services or Site to Company or any of its employees or representatives, You automatically forfeit your right to any intellectual property rights in these ideas; and (ii) ideas regarding the Company Services of the Site submitted to Company or any of its employees or representatives (including any improvements or suggestions) automatically become the property of Company. You hereby assign and agree to assign all rights, title and interest You have in such comments and ideas to Company together with all intellectual property.
          </p>
        </Typography>
      </div>
    </>
